...
def build_asset_archive_payload(date: str | None = None) -> dict[str, Any]:
    ...
    return {
        ...
        "crypto": {
            ...
            "archive_note": "코인은 BTC/ETH/XRP/XLM만 정상 운용 감시군으로 보고, 그 밖의 급변 코인은 예외 풀 5% 안에서 종목당 2.5% 한도로만 표시합니다. 주봉 상승초입이지만 진입이 늦은 예외 후보는 1% 탐색 진입과 30% 이상 넓은 손절을 별도 표시하며, 예외풀이 5%를 넘으면 6~10% 범위에서 사용자 승인을 요구하고 절대 15%를 넘기지 않습니다. USDT는 현금성 자산으로 분류합니다.",
        },
        "market": {
            "kospi200": kospi200,
